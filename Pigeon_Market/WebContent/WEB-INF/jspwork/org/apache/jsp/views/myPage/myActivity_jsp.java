 ...
 * Generated at: 2019-09-09 01:49:59 UTC
...
if(loginUser != null && loginUser.getUserId().equals("admin")){ 
      ...
      out.write("\t\t\t\t\t\t\t\t<input type=\"button\" value=\"배송조회\">\r\n");
      out.write("\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>페이지당 갯수</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"radio\" name=\"group\" value=\"15\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"radio\" name=\"group\" value=\"20\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"radio\" name=\"group\" value=\"30\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>기간</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"radio\" name=\"period\" value=\"90\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"radio\" name=\"period\" value=\"180\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"radio\" name=\"period\" value=\"365\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"radio\" name=\"period\" value=\"all\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"number\" name=\"period\" value=\"\" disabled></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>특정날짜 검색</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"date\" id=\"date1\" name=\"date1\" value=");
      out.print( today );
      out.write(" min=\"2018-01-01\" max=");
      out.print( today );
      out.write(" disabled></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"date\" id=\"date2\" name=\"date2\" value=");
      out.print( today );
      out.write(" min=\"2018-01-01\" max=");
      out.print( today );
      out.write(" disabled></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><button id=\"dateAbled\" onclick=\"dateAbled();\">해제하기</button>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><button onclick=\"filtButton();\">검색하기</button>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t </div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\tonclick=\"location.href='");
      out.print(contextPath);
      out.write("/Activity.me?status=");
      out.print(a.getStatus() );
      out.write("&page=1&group=");
      out.print(a.getLimitCount() );
      out.write("&period=");
      out.print(a.getPeriod() );
      out.write("&date='\">\r\n");
      out.write("\t\t\t\t\t\t\t&lt;&lt;</button>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<!-- 이전페이지로(<) -->\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"no\" id=\"detailNo\" value=\"\">\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"st\" id=\"detailSt\" value=\"\">\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t</section>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\tvar st = $(this).parent().children().eq(0).text();\r\n");
      out.write("\t\t\t\tvar no = $(this).parent().children().eq(1).val();\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t$('#detailNo').val(no);\r\n");
      out.write("\t\t\t\t$('#detailSt').val(st);\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tConsole.log(st);\r\n");
      out.write("\t\t\t\tConsole.log(no);\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tvar no1= $('#detailNo').val();\r\n");
      out.write("\t\t\t\tvar st1 = $('#detailSt').val();\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tConsole.log(st1);\r\n");
      out.write("\t\t\t\tConsole.log(no1);\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tlocation.href=\"");
      ...
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tfunction dateAbled() {\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tvar dateSt = $('#dateAbled').text();\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tif(dateSt == '잠그기') {\r\n");
      out.write("\t\t\t$('#date1').removeAttr(disabled);\r\n");
      out.write("\t\t\t$('#date2').removeAttr(disabled);\r\n");
      out.write("\t\t\t$('#dateAbled').text(\"해제하기\");\r\n");
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t\t$('#date1').attr(abled);\r\n");
      out.write("\t\t\t\t$('#date2').attr(abled);\r\n");
      out.write("\t\t\t\t$('#dateAbled').text(\"잠그기\");\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tfunction filtButton() {\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tvar dateSt = $('#dateAbled').text();\r\n");
      out.write("\t\t\tif(dateSt == '잠그기') {\r\n");
      out.write("\t\t\t\tDate date1 = $('#date1').val();\r\n");
      out.write("\t\t\t\tDate date2 = $('#date1').val();\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tvar dateSub = date2-date1;\r\n");
      out.write("\t\t\t\tconsole.log(dateSub);\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
