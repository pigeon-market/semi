 ...
 * Generated at: 2019-09-09 05:02:07 UTC
...
if(loginUser != null && loginUser.getUserId().equals("admin")){ 
      ...
      out.write("\t\t\t\t\t\t\t\t<input type=\"button\" value=\"해제하기\" id=\"emailBtn\" readonly>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t우편번호 : <input type=\"text\" name=\"addr1\" style=\"width:80px; height:26px;\" />\t&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t<button type=\"button\" style=\"width:60px; height:32px;\" onclick=\"openZipSearch()\">검색</button><br>\r\n");
      out.write("\t\t\t\t주소 : <input type=\"text\" name=\"addr2\" style=\"width:300px; height:30px;\" readonly /><br>\r\n");
      out.write("\t\t\t\t상세 : <input type=\"text\" name=\"addr3\" style=\"width:300px; height:30px;\" />\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class=\"col-3\" onclick=\"addrBtn();\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"button\" value=\"해제하기\" id=\"addr\" readonly>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<input type=\"button\" value=\"해제하기\" id=\"phoneBtn\" readonly>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\t\t \r\n");
      out.write("\t\t function addrBtn() {\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tif ($(\"#addrBtn\").val() == \"해제하기\") {\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t$(\"#addrBtn\").css({\r\n");
      out.write("\t\t\t\t\t\t'background-color' : 'rgba(232, 153, 128, 0.5)'\r\n");
      out.write("\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t$(\"#addr1\").val(\"\").removeAttr('readonly').css({\r\n");
      out.write("\t\t\t\t\t\t'background-color' : 'rgb(250, 250, 250)',\r\n");
      out.write("\t\t\t\t\t\t'border' : '5px solid rgba(232, 153, 128, 0.5)'\r\n");
      out.write("\t\t\t\t\t}).focus();\r\n");
      out.write("\t\t\t\t\t$(\"#addr2\").val(\"\").removeAttr('readonly').css({\r\n");
      out.write("\t\t\t\t\t\t'background-color' : 'rgb(250, 250, 250)',\r\n");
      out.write("\t\t\t\t\t\t'border' : '5px solid rgba(232, 153, 128, 0.5)'\r\n");
      out.write("\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t$(\"#addr3\").val(\"\").removeAttr('readonly').css({\r\n");
      out.write("\t\t\t\t\t\t'background-color' : 'rgb(250, 250, 250)',\r\n");
      out.write("\t\t\t\t\t\t'border' : '5px solid rgba(232, 153, 128, 0.5)'\r\n");
      out.write("\t\t\t\t\t});\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t$(\"#addrBtn\").val(\"수정하기\");\r\n");
      out.write("\t\t\t\t} else {\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\tvar addr1 = $(\"#addr1\").val();\r\n");
      out.write("\t\t\t\t\tvar addr2 = $(\"#addr2\").val();\r\n");
      out.write("\t\t\t\t\tvar addr3 = $(\"#addr3\").val();\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\t\turl : \"updateAddr.me\",\r\n");
      out.write("\t\t\t\t\t\tdata : {\r\n");
      out.write("\t\t\t\t\t\t\taddr1 : addr1,\r\n");
      out.write("\t\t\t\t\t\t\taddr2 : addr2,\r\n");
      out.write("\t\t\t\t\t\t\taddr3 : addr3\r\n");
      out.write("\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\ttype : \"post\",\r\n");
      out.write("\t\t\t\t\t\tsuccess : function(addr) {\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\tvar newAddr = addr;\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\tvar num1 = newAddr.indexOf(\",\");\r\n");
      out.write("\t\t\t\t\t\t\tvar num2 = newAddr.lastIndexOf(\",\");\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\tvar nAddr1 = newAddr.substring(0, num1);\r\n");
      out.write("\t\t\t\t\t\t\tvar nAddr2 = newAddr.substring(num1 +1, num2)\r\n");
      out.write("\t\t\t\t\t\t\tvar nAddr3 = newAddr.substring(num2 + 1);\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#addr1\").val(nAddr1);\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#addr2\").val(nAddr2);\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#addr3\").val(nAddr3);\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\terror : function() {\r\n");
